import type { DataScope, Prisma, UserStatus } from '../../lib/prisma-client.ts'
...
import { revokeSession, revokeUserSessions } from '../auth/session.service.ts'
import { saveUserProfilePhoto } from './users.storage.ts'
